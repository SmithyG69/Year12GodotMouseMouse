...
#var speed = 2.0
@export var max_kiwi = 8
var kiwi = load("res://fruit/Kiwifruit.tscn")
...
func _ready() -> void:
	...
	add_to_group("kiwi")
	$"spawn timer2".timeout.connect(_on_spawn_timer_timeout)
...
func _on_spawn_timer_timeout():
	...
	if current_kiwi < max_kiwi:
		var new_kiwi = kiwi.instantiate()
		get_tree().current_scene.add_child(new_kiwi)
		new_kiwi.global_position = global_position
